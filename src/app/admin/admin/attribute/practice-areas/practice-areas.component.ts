...
export class PracticeAreasComponent implements OnInit {
  ...
  async loadPractiveArea() {
    ...
    const getPracticeAreaInfo = Object.assign(
      {},
      this.adminConstants.QUERY.GET_PRACTICE_AREA_BY_ACTIVE
    );
    getPracticeAreaInfo.filter = getPracticeAreaInfo.filter.replace(
      /{{isActive}}/gi,
      this.adminConstants.LOGICAL_FIELD.YES
    );
    this.common.SetNewrelic(
      "admin",
      "admin-attribute-practice-areas",
    ...
    this.practiceAreaColumns = this.common.MainfilterForTable(
      this.practiceAreaColumns,
      this.practiceAreaRows
    );
  }
  ...
  async addPracticeArea() {
    ...
    if (
      ...
      this.common.showToastrMessage(
        this.constants.MessageType.error,
        "This practice area is already exist. Please enter another practice area.",
        false
      );
    ...
    this.common.showToastrMessage(
      ...
      "The practice area " + this.practiceArea + " has added successfully.",
      true
    );
    this.practiceArea = "";
    await this.loadPractiveArea();
  ...
  async confirmUpdate(data, updateData, listName, type) {
    ...
    this.common.showToastrMessage(
      this.constants.MessageType.success,
      "The practice area " + data.PracticeArea + " has deleted successfully.",
      true
    );
