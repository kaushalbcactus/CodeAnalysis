...
const routes: Routes = [
  ...
  { path: 'accessleveldashboard', loadChildren: './accessleveldashboard/accessleveldashboard.module#AccessleveldashboardModule', data: { title: 'Medcom | Dashboard' } },
  { path: 'defaultDashboard', loadChildren: './dashboard/dashboard.module#DashboardModule', data: { title: 'Medcom | Dashboard' } },
