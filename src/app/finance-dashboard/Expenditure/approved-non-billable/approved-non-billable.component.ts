...
export class ApprovedNonBillableComponent implements OnInit {
    ...
    createColFieldValues() {
        ...
        this.anonBillableColArray.ProjectCode = this.uniqueArrayObj(this.approvedNonBillableRes.map(a => { let b = { label: a.ProjectCode, value: a.ProjectCode }; return b; }));
        this.anonBillableColArray.Category = this.uniqueArrayObj(this.approvedNonBillableRes.map(a => { let b = { label: a.Category, value: a.Category }; return b; }));
        this.anonBillableColArray.ExpenseType = this.uniqueArrayObj(this.approvedNonBillableRes.map(a => { let b = { label: a.ExpenseType, value: a.ExpenseType }; return b; }));
        this.anonBillableColArray.ClientAmount = this.uniqueArrayObj(this.approvedNonBillableRes.map(a => { let b = { label: a.ClientAmount, value: a.ClientAmount }; return b; }));
        this.anonBillableColArray.ClientCurrency = this.uniqueArrayObj(this.approvedNonBillableRes.map(a => { let b = { label: a.ClientCurrency, value: a.ClientCurrency }; return b; }));

        this.anonBillableColArray.PaymentMode = this.uniqueArrayObj(this.approvedNonBillableRes.map(a => { let b = { label: a.PaymentMode, value: a.PaymentMode }; return b; }));
        this.anonBillableColArray.PayingEntity = this.uniqueArrayObj(this.approvedNonBillableRes.map(a => { let b = { label: a.PayingEntity, value: a.PayingEntity }; return b; }));
        this.anonBillableColArray.Status = this.uniqueArrayObj(this.approvedNonBillableRes.map(a => { let b = { label: a.Status, value: a.Status }; return b; }));
