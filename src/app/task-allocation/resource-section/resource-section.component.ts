...
export class ResourceSectionComponent implements OnInit {
  ...
  constructor(private spService: SharepointoperationService, private commonService: CommonService,
    private peoplePickerService: SpPeoplePickerService, private constants: ConstantsService,
  ...
  //  }
   ...
   private saveDeliveryResources() {
       const updateInformation = [], allDeliveryResources = [];
       ...
       updateInformation.push({'key': 'GraphicsMembersId', 'value': project.resources.graphicsMembersID !== '' ?
                                                                    project.resources.graphicsMembersID : []});
       updateInformation.push({'key': 'PSMembersId', 'value': project.resources.pubSupportMembersID !== '' ?
                                                              project.resources.pubSupportMembersID : []});
       updateInformation.push({'key': 'PrimaryResMembersId', 'value': project.resources.primaryResources !== '' ?
                                                                      project.resources.primaryResources : []});
       updateInformation.push({'key': 'AllDeliveryResourcesId', 'value': project.resources.allDeliveryResources !== '' ?
