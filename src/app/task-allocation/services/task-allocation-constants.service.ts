...
export class TaskAllocationConstantsService {
  ...
  taskallocationComponent = {
    ...
    Resources: {
      select: "ID,MaxHrs,TAVisibility,PrimarySkill,UserNamePG/ID,UserNamePG/EMail,UserNamePG/Title,UserNamePG/Name,TimeZone/Title,SkillLevel/Title,Tasks/Title,Tasks/Status,Deliverables/Title,DeliverableExclusion/Title,TA/Title,TAExclusion/Title,Account/Title,PrimarySkill,Bucket,Practice_x0020_Area,IsFTE, GoLiveDate",
