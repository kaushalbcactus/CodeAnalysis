...
export class TaskAllocationConstantsService {
    ...
    taskallocationComponent = {
        ...
        // projectEndPoint:{
        //     select: "ID,Title,Task,SkillLevel,TATStatus,Comments,Status,AllowCompletion,NextTasks,FileSystemObjectType,ExpectedTime,PrevTasks,Milestone,TimeSpent,StartDate,DueDate,PreviousTaskClosureDate,IsCentrallyAllocated,CentralAllocationDone,Actual_x0020_End_x0020_Date,Actual_x0020_Start_x0020_Date,TaskPosition,AssignedTo/ID,AssignedTo/Name,AssignedTo/Title,AssignedTo/EMail",
        //     orderby:"StartDate asc",
        //     expand:"AssignedTo/ID,AssignedTo/Name,AssignedTo/Title,AssignedTo/EMail",
        //     filter: "ProjectCode eq '{{projectCode}}'",
        //     top: 4500  
        ...
        // getProjectResource: {
        //     ProjectResource: this.globalObject.sharePointPageObject.webAbsoluteUrl + "/_api/web/lists/GetByTitle('" + this.constantService.listNames.ProjectInformation + "')/items",
        // },
        // getResource: {
        //     Resource: this.globalObject.sharePointPageObject.webAbsoluteUrl + "/_api/web/lists/GetByTitle('" + this.constantService.listNames.ResourceCategorization + "')/items",
        // },
        // getBudgetHours:{
        //     BudgetHours:  this.globalObject.sharePointPageObject.webAbsoluteUrl + "/_api/web/lists/getbytitle('" + this.constantService.listNames.ProjectFinances + "')/items",
        // },
        // getClientLegal:{
        //     ClientLegal: this.globalObject.sharePointPageObject.webAbsoluteUrl +"/_api/web/lists/getbytitle('" + this.constantService.listNames.ClientLegalEntity + "')/items"
        // },
        // getAccessUrl:{
        //     AccessUrl: this.globalObject.sharePointPageObject.webAbsoluteUrl +"/_api/web/lists/getbytitle('" + this.constantService.listNames.ProjectInformation + "')/items"
        // },
        // getmilestoneEndpoint:{
        //     milestoneEndpoint: this.globalObject.sharePointPageObject.webAbsoluteUrl +"/_api/web/lists/getbytitle('" + this.constantService.listNames.Milestones + "')/items"
        // },
        // gettaskEndpoint:{
        //         taskEndPoint: this.globalObject.sharePointPageObject.webAbsoluteUrl + "/_api/web/lists/getbytitle('" + this.constantService.listNames.MilestoneTasks + "')/items"
        // },
        // getmilestone:{
        //     milestone:  this.globalObject.sharePointPageObject.webAbsoluteUrl +"/_api/web/lists/getbytitle('" + this.constantService.listNames.Schedules + "')/items"
        // },
        getUserFromGroup:{
