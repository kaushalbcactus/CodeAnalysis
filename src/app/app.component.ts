...
export class AppComponent {
  ...
  ngOnInit() {
    ...
    this.globalObject.sharePointPageObject.serverRelativeUrl = window.location.href.indexOf('localhost') > -1 ?
      ...
      this.globalObject.sharePointPageObject.webRelativeUrl = this.globalObject.sharePointPageObject.serverRelativeUrl;
    this.globalObject.currentUser.id = location.origin.indexOf('localhost') > -1 ? 287 : _spPageContextInfo.userId; //// To be removed;
