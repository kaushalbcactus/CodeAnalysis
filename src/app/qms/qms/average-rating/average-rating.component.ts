...
export class AverageRatingComponent implements OnInit, OnChanges {
  ...
  public ratingTypes = {
    Write: 'Write', Edit: 'Editor', Quality: 'QC', Graphics: 'Graphics', Reviewer: ''
  };
  cols: any[];
  ...
  getAverageRating(itemsArray, type) {
    ...
    const totalRating = arrTaskFeedback.reduce((a, b) => a + (b.AverageRatingNM ? +b.AverageRatingNM : +b.AverageRating) , 0);
