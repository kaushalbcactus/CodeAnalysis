...
export class SharedConstantsService {
  ...
  public userCapacity = {
    fetchTasks: {
      select: 'ID,Milestone,ProjectCode,SubMilestones,Task,Status,Title,TimeSpent,ExpectedTime,StartDate,DueDate,TimeZone,ParentSlot,AllocationPerDay,Comments,Entity',
