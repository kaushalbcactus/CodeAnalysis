...
export class UsercapacityComponent implements OnInit {
  ...
  //     arrDateFormat: [],
  //   };
  //   obj.arrDateRange = this.userCapacityCommon.getDates(startDate, endDate, false).dateArray;
  //   obj.arrDateFormat = this.userCapacityCommon.getDates(startDate, endDate, false).dateArray;
  ...
  //         arrLeaves = $.merge(
  //           arrLeaves,
  //           this.userCapacityCommon.getDates(leaves[i].EventDate, leaves[i].EndDate, true)
  //             .dateArray
  //         );
  ...
  //   const updatedCapacity = this.userCapacityCommon.fetchUserCapacity(usercapacity);
  ...
  changeHeight(user, objt) {
    if (objt.currentTarget.classList[1] === "more") {
      // objt.currentTarget.parentNode.parentNode.parentNode.nextElementSibling.getElementsByTagName('div')
      // $(objt.currentTarget)
      //   .parent()
      //   .parent()
      //   .parent()
