...
export class UsercapacityComponent implements OnInit {
  ...
  constructor(public datepipe: DatePipe,
              private spService: SPOperationService, private caGlobalService: CAGlobalService, private globalConstantService: ConstantsService,
              private commonservice: CACommonService, elRef: ElementRef, private GlobalService: GlobalService ) {
                  this.elRef = elRef;
                }
